...
# Hide default Streamlit UI (makes it look pro)
hide_style = """
    <style>
...
LANGUAGES = {
    "Spanish": "es", "English": "en", "Telugu": "te", "Hindi": "hi", "Tamil": "ta",
    "Kannada": "kn", "Malayalam": "ml", "Marathi": "mr", "Gujarati": "gu", "Punjabi": "pa",
    "Bengali": "bn", "Urdu": "ur", "Odia": "or", "Assamese": "as", "Sanskrit": "sa",
    "French": "fr", "German": "de", "Italian": "it", "Portuguese": "pt", "Russian": "ru",
    "Japanese": "ja", "Korean": "ko", "Chinese (Simplified)": "zh-CN", "Chinese (Traditional)": "zh-TW", "Arabic": "ar",
    "Turkish": "tr", "Dutch": "nl", "Polish": "pl", "Thai": "th", "Vietnamese": "vi",
    "Indonesian": "id", "Malay": "ms", "Filipino": "tl", "Greek": "el", "Hebrew": "iw",
    "Persian": "fa", "Ukrainian": "uk", "Romanian": "ro", "Hungarian": "hu", "Czech": "cs",
    "Slovak": "sk", "Bulgarian": "bg", "Croatian": "hr", "Serbian": "sr", "Slovenian": "sl",
    "Danish": "da", "Swedish": "sv", "Norwegian": "no", "Finnish": "fi", "Lithuanian": "lt",
    "Latvian": "lv", "Estonian": "et", "Swahili": "sw", "Afrikaans": "af", "Albanian": "sq",
    "Belarusian": "be", "Catalan": "ca", "Irish": "ga", "Maltese": "mt", "Welsh": "cy",
}
...
if st.session_state.source_lang not in LANGUAGES:
    st.session_state.source_lang = "Spanish"
if st.session_state.target_lang not in LANGUAGES:
    st.session_state.target_lang = "English"
...
def copy_to_clipboard_button(text: str, label: str = "📋 Copy"):
    ...
    components.html(
        f"""
        <button id="copy-btn" style="width:100%; padding:0.55em 1em; border-radius:0.5em;
            border:1px solid rgba(49,51,63,0.2); background-color:#ffffff;
            cursor:pointer; font-size:0.95rem;">{label}</button>
        <script>
...
st.caption("Instant translation between 60+ languages")
...
with mid:
    st.button("🔄 Swap Languages", use_container_width=True, on_click=swap_languages)
...
col1, col2 = st.columns(2)
with col1:
    st.button("🔥 Translate", use_container_width=True, type="primary", on_click=translate_text)
with col2:
